        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4 relative z-20">
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-2xl">
              Explore thousands of movies with ratings, reviews, and detailed
              information from IMDB. Analyze dozen of interactive plots suchs as
              wordclouds generated by a movies user reviews or income
